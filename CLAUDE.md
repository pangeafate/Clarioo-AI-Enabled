...
2. Never write code before writing failing test first - follow GL-TDD (See GL-TDD.md for complete framework including Phase 0 Visual Prototype exceptions in lines 37-67. Phase 1+ Requirements: Automated tests are REQUIRED for all n8n integration code including services, hooks, and API functions. Visual verification is acceptable for UI/UX components during rapid prototyping.)
