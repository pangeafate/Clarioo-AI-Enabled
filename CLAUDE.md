...
2. Never write code before writing failing test first - follow GL-TDD (Phase 1 Testing Requirements: Automated tests are REQUIRED for all n8n integration code including services, hooks, and API functions. Visual verification is acceptable for UI/UX components during rapid prototyping.)
