...
export const AccordionSection: React.FC<AccordionSectionProps> = ({
  ...
  return (
    <div className={`border rounded-lg overflow-hidden bg-white border-l-4 ${colors.border}`}>
      ...
      <button
        onClick={onToggle}
        className={`w-full px-4 py-3 flex items-center justify-between transition-colors ${colors.bg} hover:opacity-80`}
      >
        {/* Title and Count */}
            ...
            <div className="p-4 pt-0 space-y-3">
              ...
              >
                <div className="px-4 py-3 flex items-center justify-center gap-2 text-muted-foreground hover:text-primary group">
                  ...
                  <span className="font-medium">Add {title} Criterion</span>
                </div>
              </button>
            </div>
          </motion.div>
