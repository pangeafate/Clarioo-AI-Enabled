...
export async function createProjectFromExportData(
  ...
  try {
    ...
    const project: Project = {
      ...
      category: templateData.metadata?.softwareCategory || templateData.metadata?.category || 'Software',
      status: 'in-progress',
      created_at: now,
      updated_at: now,
    };
...
export async function createProjectFromJSONTemplate(
  ...
  try {
    ...
    const project: Project = {
      ...
      category: projectData.metadata?.softwareCategory || projectData.metadata?.category || 'Software',
      status: 'in-progress',
      created_at: now,
      updated_at: now,
    };
