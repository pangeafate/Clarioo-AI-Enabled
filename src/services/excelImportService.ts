 ...
 * Calls the main importExcelToJson() function
 *
 * @deprecated Use importExcelToJson() instead
 */
export async function importExcelTemplate(args: {
  file: File;
}): Promise<ImportResult> {
  return importExcelToJson(args.file);
}
